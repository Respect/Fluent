...
use Respect\Fluent\Test\Fixtures\SimpleBuilder;
...
final class AppendTest extends TestCase
{
    ...
    #[Test]
    public function itShouldSupportCallStatic(): void
    {
        /** @phpstan-ignore staticMethod.notFound (__callStatic handles this) */
        $result = SimpleBuilder::foo('hello');

        self::assertInstanceOf(SimpleBuilder::class, $result);
        self::assertCount(1, $result->getNodes());
        self::assertInstanceOf(NsAFoo::class, $result->getNodes()[0]);
        self::assertSame('hello', $result->getNodes()[0]->value);
    }
